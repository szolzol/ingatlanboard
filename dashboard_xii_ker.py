"""
STREAMLIT DASHBOARD - XII. KERÜLET INGATLAN ELEMZÉS (GPS koordinátákkal)
========================================================================

🎯 Egyedi dashboard XII. kerületi ingatlanokhoz koordináta alapú térképpel
📊 Adatforrás: ingatlan_reszletes_XII_KERÜLET_koordinatak_20250822_142009.csv
...
def load_and_process_data():
    """Adatok betöltése és feldolgozása - XII kerületi koordinátás CSV"""
    try:
        # Koordinátás CSV pattern keresés - XII kerület specifikus
        location_patterns = [
            "ingatlan_reszletes_XII_KERÜLET_koordinatak_*.csv",  # Koordinátás változat prioritás
            "ingatlan_reszletes_xii_ker_*_koordinatak_*.csv",    # Alternative pattern
            "ingatlan_reszletes_XII_KERÜLET_*.csv",              # Fallback basic
            "ingatlan_*xii_ker*.csv"                             # Wildcard fallback
        ]
        ...
        st.error("HIBA: Nincs található XII kerületi CSV fájl!")
        return pd.DataFrame()
