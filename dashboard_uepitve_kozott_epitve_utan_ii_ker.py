...
def get_location_from_filename():
    # Új egyszerűsített formátum: ingatlan_reszletes_elado_haz_80_600_mFt_xii_ker_20_20250821_154446.csv  
    detailed_files = glob.glob("ingatlan_reszletes_*.csv")
    if detailed_files:
        latest_file = max(detailed_files)
        # Példa: "ingatlan_reszletes_elado_haz_80_600_mFt_xii_ker_20_20250821_154446.csv"
        ...
        if len(filename_parts) >= 10:
            ...
            # xii_ker_20 rész kinyerése (7, 8, 9 indexek) - nincs már "enhanced_text_features"
            location_parts = []
            for i in range(7, len(filename_parts)-2):  # utolsó 2 elem időbélyeg
